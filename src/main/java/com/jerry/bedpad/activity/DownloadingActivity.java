...
import com.jerry.bedpad.util.AutoInstall;
import com.jerry.bedpad.util.L;
import com.jerry.bedpad.util.MyProgressCallBack;
import com.jerry.bedpad.util.T;
import com.jerry.bedpad.util.XUtil;
import com.jerry.bedpad.view.RoundProgressBar;
...
public class DownloadingActivity extends Activity {
    ...
    private void downloadAPK() {
        XUtil.DownLoadFile(Constant.APK_URL, APK_SAVE_URL, new MyProgressCallBack<File>() {
